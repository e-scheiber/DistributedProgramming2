...
public class Client{
  public static void main(String args[]){
    ...
    String urlStr="http://localhost:8080/HelloWorld/webresources/helloworld";
    try{
    ...
    urlStr="http://localhost:8080/HelloWorld/webresources/helloworld/html";
    try{
      String rezultat=httpGetText(urlStr);
      System.out.println(rezultat);
    }
    ...
    urlStr="http://localhost:8080/HelloWorld/webresources/helloworld/xml";
    try{
      String rezultat=httpGetText(urlStr);
      System.out.println(rezultat);
    }
