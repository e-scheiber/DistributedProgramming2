...
public class Client{
  public static void main(String args[]){
    ...
    String urlStr="http://localhost:8080/hw/webapi/helloworld";
    try{
    ...
    urlStr="http://localhost:8080/hw/webapi/helloworld/html";
    try{
      String rezultat=httpGetText(urlStr);
      System.out.println(rezultat);
    }
    ...
    urlStr="http://localhost:8080/hw/webapi/helloworld/xml";
    try{
      String rezultat=httpGetText(urlStr);
      System.out.println(rezultat);
    }
