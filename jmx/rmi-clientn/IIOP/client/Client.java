...
public class Client {
  public static void main(String[] args) {
    ...
    try {
      // Crearea unui conector IIOP si a obiectului de tip MBeanServercsection
      ...
      IntroNMBean proxy = (IntroNMBean)MBeanServerInvocationHandler.newProxyInstance(
               cs,
               mbeanObjectName,
               client.IntroNMBean.class,
               true);
